...
const Hero = () => {
  return (
    <section id="home" className=" bg-lightGreen px-8 md:px-16 lg:px-32">
      <div className="mx-auto min-h-[858px] max-w-[1280px] pb-20 pt-4 md:pt-20  flex flex-col-reverse md:flex-row items-center">
        <div className="w-full md:w-2/3 pr-0 md:pr-8  text-center md:text-left">
          ...
          <p className="text-lg md:text-xl mb-8 md:max-w-[800px]">
